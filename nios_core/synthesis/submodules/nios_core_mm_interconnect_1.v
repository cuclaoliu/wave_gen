...
module nios_core_mm_interconnect_1 (
		...
		input  wire [8:0]  clock_crossing_bridge_m0_address,                           //                             clock_crossing_bridge_m0.address
	...
	wire         clock_crossing_bridge_m0_translator_avalon_universal_master_0_waitrequest;   // clock_crossing_bridge_m0_agent:av_waitrequest -> clock_crossing_bridge_m0_translator:uav_waitrequest
	wire  [31:0] clock_crossing_bridge_m0_translator_avalon_universal_master_0_readdata;      // clock_crossing_bridge_m0_agent:av_readdata -> clock_crossing_bridge_m0_translator:uav_readdata
	wire         clock_crossing_bridge_m0_translator_avalon_universal_master_0_debugaccess;   // clock_crossing_bridge_m0_translator:uav_debugaccess -> clock_crossing_bridge_m0_agent:av_debugaccess
	wire   [8:0] clock_crossing_bridge_m0_translator_avalon_universal_master_0_address;       // clock_crossing_bridge_m0_translator:uav_address -> clock_crossing_bridge_m0_agent:av_address
	wire         clock_crossing_bridge_m0_translator_avalon_universal_master_0_read;          // clock_crossing_bridge_m0_translator:uav_read -> clock_crossing_bridge_m0_agent:av_read
	wire   [3:0] clock_crossing_bridge_m0_translator_avalon_universal_master_0_byteenable;    // clock_crossing_bridge_m0_translator:uav_byteenable -> clock_crossing_bridge_m0_agent:av_byteenable
	wire         clock_crossing_bridge_m0_translator_avalon_universal_master_0_readdatavalid; // clock_crossing_bridge_m0_agent:av_readdatavalid -> clock_crossing_bridge_m0_translator:uav_readdatavalid
	wire         clock_crossing_bridge_m0_translator_avalon_universal_master_0_lock;          // clock_crossing_bridge_m0_translator:uav_lock -> clock_crossing_bridge_m0_agent:av_lock
	wire         clock_crossing_bridge_m0_translator_avalon_universal_master_0_write;         // clock_crossing_bridge_m0_translator:uav_write -> clock_crossing_bridge_m0_agent:av_write
	wire  [31:0] clock_crossing_bridge_m0_translator_avalon_universal_master_0_writedata;     // clock_crossing_bridge_m0_translator:uav_writedata -> clock_crossing_bridge_m0_agent:av_writedata
	wire   [2:0] clock_crossing_bridge_m0_translator_avalon_universal_master_0_burstcount;    // clock_crossing_bridge_m0_translator:uav_burstcount -> clock_crossing_bridge_m0_agent:av_burstcount
	...
	wire  [83:0] ledg_s1_agent_rf_source_data;                                                // ledg_s1_agent:rf_source_data -> ledg_s1_agent_rsp_fifo:in_data
	...
	wire  [83:0] ledg_s1_agent_rsp_fifo_out_data;                                             // ledg_s1_agent_rsp_fifo:out_data -> ledg_s1_agent:rf_sink_data
	...
	wire         cmd_mux_src_valid;                                                           // cmd_mux:src_valid -> ledg_s1_agent:cp_valid
	wire  [82:0] cmd_mux_src_data;                                                            // cmd_mux:src_data -> ledg_s1_agent:cp_data
	wire         cmd_mux_src_ready;                                                           // ledg_s1_agent:cp_ready -> cmd_mux:src_ready
	wire   [5:0] cmd_mux_src_channel;                                                         // cmd_mux:src_channel -> ledg_s1_agent:cp_channel
	wire         cmd_mux_src_startofpacket;                                                   // cmd_mux:src_startofpacket -> ledg_s1_agent:cp_startofpacket
	wire         cmd_mux_src_endofpacket;                                                     // cmd_mux:src_endofpacket -> ledg_s1_agent:cp_endofpacket
	...
	wire  [83:0] ledr_s1_agent_rf_source_data;                                                // ledr_s1_agent:rf_source_data -> ledr_s1_agent_rsp_fifo:in_data
	...
	wire  [83:0] ledr_s1_agent_rsp_fifo_out_data;                                             // ledr_s1_agent_rsp_fifo:out_data -> ledr_s1_agent:rf_sink_data
	...
	wire  [82:0] cmd_mux_001_src_data;                                                        // cmd_mux_001:src_data -> ledr_s1_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                       // ledr_s1_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [5:0] cmd_mux_001_src_channel;                                                     // cmd_mux_001:src_channel -> ledr_s1_agent:cp_channel
	...
	wire  [82:0] cmd_mux_002_src_data;                                                        // cmd_mux_002:src_data -> key_s1_agent:cp_data
	...
	wire         clock_crossing_bridge_m0_agent_cp_valid;                                     // clock_crossing_bridge_m0_agent:cp_valid -> router:sink_valid
	wire  [82:0] clock_crossing_bridge_m0_agent_cp_data;                                      // clock_crossing_bridge_m0_agent:cp_data -> router:sink_data
	wire         clock_crossing_bridge_m0_agent_cp_ready;                                     // router:sink_ready -> clock_crossing_bridge_m0_agent:cp_ready
	wire         clock_crossing_bridge_m0_agent_cp_startofpacket;                             // clock_crossing_bridge_m0_agent:cp_startofpacket -> router:sink_startofpacket
	wire         clock_crossing_bridge_m0_agent_cp_endofpacket;                               // clock_crossing_bridge_m0_agent:cp_endofpacket -> router:sink_endofpacket
	wire         ledg_s1_agent_rp_valid;                                                      // ledg_s1_agent:rp_valid -> router_001:sink_valid
	wire  [82:0] ledg_s1_agent_rp_data;                                                       // ledg_s1_agent:rp_data -> router_001:sink_data
	wire         ledg_s1_agent_rp_ready;                                                      // router_001:sink_ready -> ledg_s1_agent:rp_ready
	wire         ledg_s1_agent_rp_startofpacket;                                              // ledg_s1_agent:rp_startofpacket -> router_001:sink_startofpacket
	wire         ledg_s1_agent_rp_endofpacket;                                                // ledg_s1_agent:rp_endofpacket -> router_001:sink_endofpacket
	...
	wire  [82:0] ledr_s1_agent_rp_data;                                                       // ledr_s1_agent:rp_data -> router_002:sink_data
	...
	wire  [82:0] key_s1_agent_rp_data;                                                        // key_s1_agent:rp_data -> router_003:sink_data
	...
	wire         router_src_valid;                                                            // router:src_valid -> clock_crossing_bridge_m0_limiter:cmd_sink_valid
	wire  [82:0] router_src_data;                                                             // router:src_data -> clock_crossing_bridge_m0_limiter:cmd_sink_data
	wire         router_src_ready;                                                            // clock_crossing_bridge_m0_limiter:cmd_sink_ready -> router:src_ready
	wire   [5:0] router_src_channel;                                                          // router:src_channel -> clock_crossing_bridge_m0_limiter:cmd_sink_channel
	wire         router_src_startofpacket;                                                    // router:src_startofpacket -> clock_crossing_bridge_m0_limiter:cmd_sink_startofpacket
	wire         router_src_endofpacket;                                                      // router:src_endofpacket -> clock_crossing_bridge_m0_limiter:cmd_sink_endofpacket
	wire  [82:0] clock_crossing_bridge_m0_limiter_cmd_src_data;                               // clock_crossing_bridge_m0_limiter:cmd_src_data -> cmd_demux:sink_data
	wire         clock_crossing_bridge_m0_limiter_cmd_src_ready;                              // cmd_demux:sink_ready -> clock_crossing_bridge_m0_limiter:cmd_src_ready
	wire   [5:0] clock_crossing_bridge_m0_limiter_cmd_src_channel;                            // clock_crossing_bridge_m0_limiter:cmd_src_channel -> cmd_demux:sink_channel
	wire         clock_crossing_bridge_m0_limiter_cmd_src_startofpacket;                      // clock_crossing_bridge_m0_limiter:cmd_src_startofpacket -> cmd_demux:sink_startofpacket
	wire         clock_crossing_bridge_m0_limiter_cmd_src_endofpacket;                        // clock_crossing_bridge_m0_limiter:cmd_src_endofpacket -> cmd_demux:sink_endofpacket
	wire         rsp_mux_src_valid;                                                           // rsp_mux:src_valid -> clock_crossing_bridge_m0_limiter:rsp_sink_valid
	wire  [82:0] rsp_mux_src_data;                                                            // rsp_mux:src_data -> clock_crossing_bridge_m0_limiter:rsp_sink_data
	wire         rsp_mux_src_ready;                                                           // clock_crossing_bridge_m0_limiter:rsp_sink_ready -> rsp_mux:src_ready
	wire   [5:0] rsp_mux_src_channel;                                                         // rsp_mux:src_channel -> clock_crossing_bridge_m0_limiter:rsp_sink_channel
	wire         rsp_mux_src_startofpacket;                                                   // rsp_mux:src_startofpacket -> clock_crossing_bridge_m0_limiter:rsp_sink_startofpacket
	wire         rsp_mux_src_endofpacket;                                                     // rsp_mux:src_endofpacket -> clock_crossing_bridge_m0_limiter:rsp_sink_endofpacket
	wire         clock_crossing_bridge_m0_limiter_rsp_src_valid;                              // clock_crossing_bridge_m0_limiter:rsp_src_valid -> clock_crossing_bridge_m0_agent:rp_valid
	wire  [82:0] clock_crossing_bridge_m0_limiter_rsp_src_data;                               // clock_crossing_bridge_m0_limiter:rsp_src_data -> clock_crossing_bridge_m0_agent:rp_data
	wire         clock_crossing_bridge_m0_limiter_rsp_src_ready;                              // clock_crossing_bridge_m0_agent:rp_ready -> clock_crossing_bridge_m0_limiter:rsp_src_ready
	wire   [5:0] clock_crossing_bridge_m0_limiter_rsp_src_channel;                            // clock_crossing_bridge_m0_limiter:rsp_src_channel -> clock_crossing_bridge_m0_agent:rp_channel
	wire         clock_crossing_bridge_m0_limiter_rsp_src_startofpacket;                      // clock_crossing_bridge_m0_limiter:rsp_src_startofpacket -> clock_crossing_bridge_m0_agent:rp_startofpacket
	wire         clock_crossing_bridge_m0_limiter_rsp_src_endofpacket;                        // clock_crossing_bridge_m0_limiter:rsp_src_endofpacket -> clock_crossing_bridge_m0_agent:rp_endofpacket
	...
	wire   [5:0] clock_crossing_bridge_m0_limiter_cmd_valid_data;                             // clock_crossing_bridge_m0_limiter:cmd_src_valid -> cmd_demux:sink_valid
	wire         ledg_s1_agent_rdata_fifo_src_valid;                                          // ledg_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter:in_0_valid
	wire  [33:0] ledg_s1_agent_rdata_fifo_src_data;                                           // ledg_s1_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	wire         ledg_s1_agent_rdata_fifo_src_ready;                                          // avalon_st_adapter:in_0_ready -> ledg_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_out_0_valid;                                               // avalon_st_adapter:out_0_valid -> ledg_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_out_0_data;                                                // avalon_st_adapter:out_0_data -> ledg_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_out_0_ready;                                               // ledg_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire   [0:0] avalon_st_adapter_out_0_error;                                               // avalon_st_adapter:out_0_error -> ledg_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_master_agent #(
		...
		.USE_READRESPONSE          (0),
		.USE_WRITERESPONSE         (0)
	) clock_crossing_bridge_m0_agent (
		.clk                   (altpll_sys_c3_clk),                                                           //       clk.clk
		...
		.cp_valid              (clock_crossing_bridge_m0_agent_cp_valid),                                     //        cp.valid
		.cp_data               (clock_crossing_bridge_m0_agent_cp_data),                                      //          .data
		.cp_startofpacket      (clock_crossing_bridge_m0_agent_cp_startofpacket),                             //          .startofpacket
		.cp_endofpacket        (clock_crossing_bridge_m0_agent_cp_endofpacket),                               //          .endofpacket
		.cp_ready              (clock_crossing_bridge_m0_agent_cp_ready),                                     //          .ready
		.rp_valid              (clock_crossing_bridge_m0_limiter_rsp_src_valid),                              //        rp.valid
		.rp_data               (clock_crossing_bridge_m0_limiter_rsp_src_data),                               //          .data
		.rp_channel            (clock_crossing_bridge_m0_limiter_rsp_src_channel),                            //          .channel
		.rp_startofpacket      (clock_crossing_bridge_m0_limiter_rsp_src_startofpacket),                      //          .startofpacket
		.rp_endofpacket        (clock_crossing_bridge_m0_limiter_rsp_src_endofpacket),                        //          .endofpacket
		.rp_ready              (clock_crossing_bridge_m0_limiter_rsp_src_ready),                              //          .ready
		.av_response           (),                                                                            // (terminated)
		.av_writeresponsevalid ()                                                                             // (terminated)
	);
	...
	nios_core_mm_interconnect_1_router router (
		.sink_ready         (clock_crossing_bridge_m0_agent_cp_ready),                    //      sink.ready
		.sink_valid         (clock_crossing_bridge_m0_agent_cp_valid),                    //          .valid
		.sink_data          (clock_crossing_bridge_m0_agent_cp_data),                     //          .data
		.sink_startofpacket (clock_crossing_bridge_m0_agent_cp_startofpacket),            //          .startofpacket
		.sink_endofpacket   (clock_crossing_bridge_m0_agent_cp_endofpacket),              //          .endofpacket
		.clk                (altpll_sys_c3_clk),                                          //       clk.clk
		.reset              (clock_crossing_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_core_mm_interconnect_1_router_001 router_006 (
	...
	altera_merlin_traffic_limiter #(
		...
		.REORDER                   (0)
	) clock_crossing_bridge_m0_limiter (
		.clk                    (altpll_sys_c3_clk),                                          //       clk.clk
		.reset                  (clock_crossing_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		...
		.cmd_src_ready          (clock_crossing_bridge_m0_limiter_cmd_src_ready),             //   cmd_src.ready
		.cmd_src_data           (clock_crossing_bridge_m0_limiter_cmd_src_data),              //          .data
		.cmd_src_channel        (clock_crossing_bridge_m0_limiter_cmd_src_channel),           //          .channel
		.cmd_src_startofpacket  (clock_crossing_bridge_m0_limiter_cmd_src_startofpacket),     //          .startofpacket
		.cmd_src_endofpacket    (clock_crossing_bridge_m0_limiter_cmd_src_endofpacket),       //          .endofpacket
		...
		.rsp_src_ready          (clock_crossing_bridge_m0_limiter_rsp_src_ready),             //   rsp_src.ready
		.rsp_src_valid          (clock_crossing_bridge_m0_limiter_rsp_src_valid),             //          .valid
		.rsp_src_data           (clock_crossing_bridge_m0_limiter_rsp_src_data),              //          .data
		.rsp_src_channel        (clock_crossing_bridge_m0_limiter_rsp_src_channel),           //          .channel
		.rsp_src_startofpacket  (clock_crossing_bridge_m0_limiter_rsp_src_startofpacket),     //          .startofpacket
		.rsp_src_endofpacket    (clock_crossing_bridge_m0_limiter_rsp_src_endofpacket),       //          .endofpacket
		.cmd_src_valid          (clock_crossing_bridge_m0_limiter_cmd_valid_data)             // cmd_valid.data
	);

	nios_core_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (altpll_sys_c3_clk),                                          //        clk.clk
		.reset              (clock_crossing_bridge_m0_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
		.sink_ready         (clock_crossing_bridge_m0_limiter_cmd_src_ready),             //       sink.ready
		.sink_channel       (clock_crossing_bridge_m0_limiter_cmd_src_channel),           //           .channel
		.sink_data          (clock_crossing_bridge_m0_limiter_cmd_src_data),              //           .data
		.sink_startofpacket (clock_crossing_bridge_m0_limiter_cmd_src_startofpacket),     //           .startofpacket
		.sink_endofpacket   (clock_crossing_bridge_m0_limiter_cmd_src_endofpacket),       //           .endofpacket
		.sink_valid         (clock_crossing_bridge_m0_limiter_cmd_valid_data),            // sink_valid.data
	...
	nios_core_mm_interconnect_1_cmd_mux cmd_mux_005 (
		.clk                 (altpll_sys_c3_clk),                                          //       clk.clk
		.reset               (clock_crossing_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_core_mm_interconnect_1_rsp_demux rsp_demux_005 (
		.clk                (altpll_sys_c3_clk),                                          //       clk.clk
		.reset              (clock_crossing_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_core_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (altpll_sys_c3_clk),                                          // in_clk_0.clk
		.in_rst_0_reset (clock_crossing_bridge_m0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
